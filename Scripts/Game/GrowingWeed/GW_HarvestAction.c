...
{
	[Attribute("", UIWidgets.ResourceNamePicker, desc: "Prefab spawned into the player's inventory on harvest (e.g. a cannabis-top item). Leave empty to just remove the plant with no yield.", params: "et")]
